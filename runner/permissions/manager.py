...
Gestisce i permessi per le operazioni del runner.
"""
...
class PermissionManager:
    """Gestisce i permessi del runner"""
    ...
    def check_tool_permission(self, tool_name: str, args: Dict[str, Any]) -> bool:
        """
        Verifica se un tool può essere eseguito con gli args forniti
        ...
        Returns:
            True se permesso, False altrimenti
        """
    ...
    def _check_shell_permission(self, args: Dict[str, Any]) -> bool:
        ...
        # Estrai il comando base (primo token)
    ...
    def _is_path_under(path: Path, parent: Path) -> bool:
        """Verifica se path è sotto parent"""
        try:
